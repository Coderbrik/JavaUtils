...
public class DynamicEnchantmentMeta implements ItemMeta {
	...
	public boolean addEnchant(Enchantment ench, int level, boolean ignoreLevelRestrictions) {
		if (stored) return ((EnchantmentStorageMeta) meta).addStoredEnchant(ench, level, ignoreLevelRestrictions);
		return meta.addEnchant(ench, level, ignoreLevelRestrictions);
	}
	
	@Override
	public Map<Enchantment, Integer> getEnchants() {
		if (stored) return ((EnchantmentStorageMeta) meta).getStoredEnchants();
	...
	public int getEnchantLevel(Enchantment arg0) {
		if (stored) return ((EnchantmentStorageMeta) meta).getStoredEnchantLevel(arg0);
	...
	public boolean hasConflictingEnchant(Enchantment arg0) {
		if (stored) return ((EnchantmentStorageMeta) meta).hasConflictingStoredEnchant(arg0);
	...
	public boolean hasEnchant(Enchantment arg0) {
		if (stored) return ((EnchantmentStorageMeta) meta).hasEnchant(arg0);
		return meta.hasEnchant(arg0);
	}
	
	@Override
	public boolean hasEnchants() {
		if (stored) return ((EnchantmentStorageMeta) meta).hasStoredEnchants();
	...
	public boolean removeEnchant(Enchantment arg0) {
		if (stored) return ((EnchantmentStorageMeta) meta).removeStoredEnchant(arg0);
